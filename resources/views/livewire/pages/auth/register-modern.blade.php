    ...
    <div class="split-container">
        ...
        <div class="form-section">
            ...
            <div class="form-container">
                ...
                <p class="subtitle">Join us and start managing your orders today.</p>

                <form wire:submit="register">
                    <div class="form-group">
                        <label for="name">Full Name</label>
                        <input wire:model="name" type="text" id="name" placeholder="John Doe" required autofocus>
                        @error('name') <span class="error-msg">{{ $message }}</span> @enderror
                    </div>

                    <div class="form-group">
                        <label for="email">Email Address</label>
                        <input wire:model="email" type="email" id="email" placeholder="john@example.com" required>
                ...
                <p class="footer-text">
                    Already have an account? <a href="{{ route('login') }}" wire:navigate>Log in here</a>
                </p>
            </div>
        </div>
