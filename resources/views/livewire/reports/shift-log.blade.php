<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[2.5rem] shadow-sm">
        ...
        <div class="flex items-center gap-3">
             <input type="date" wire:model.live="dateFrom" class="bg-slate-50 dark:bg-slate-800 border-none rounded-xl text-[10px] font-black uppercase tracking-widest py-3 px-4 focus:ring-4 focus:ring-indigo-500/10">
             <span class="text-slate-300">/</span>
             <input type="date" wire:model.live="dateTo" class="bg-slate-50 dark:bg-slate-800 border-none rounded-xl text-[10px] font-black uppercase tracking-widest py-3 px-4 focus:ring-4 focus:ring-indigo-500/10">
        </div>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-8 py-32 text-center grayscale opacity-30">
                                ...
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">No Operational Records</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
